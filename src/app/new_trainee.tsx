...
import {
  ContactInfoSection,
  CorporateMappingSection,
  EmploymentDetailsSection,
  LeadershipContextSection,
  SystemAccessSection,
  TraineeProfileSection,
  useNewTraineeForm,
} from "@/components/trainee/new-trainee";

export default function NewTraineeScreen() {
  const router = useRouter();
  const form = useNewTraineeForm();
      ...
      <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
        <View style={styles.header}>
          ...
          <View style={styles.headerTextGroup}>
            <AppText style={styles.headerTitle} weight={FontWeight.semiBold}>New Trainee Registration</AppText>
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          <CorporateMappingSection form={form} />
          <LeadershipContextSection form={form} />
          <TraineeProfileSection form={form} />
          <ContactInfoSection form={form} />
          <EmploymentDetailsSection form={form} />
          <SystemAccessSection form={form} />
        </ScrollView>
      </SafeAreaView>
    </>
  );
